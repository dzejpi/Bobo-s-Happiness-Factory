...
var wrap_guide_1 = Vector2(-10, -4)
var wrap_guide_2 = Vector2(10, -4)
var wrap_guide_3 = Vector2(0, -8)
var wrap_guide_4 = Vector2(0, 20)
var wrap_guide_5 = Vector2(10, 16)
...
func _process(delta):
	...
	if is_fallen:
		if tea_sprite.scale.x > 0.5:
			tea_sprite.scale.x -= 0.025
			tea_sprite.scale.y -= 0.025
			...
			if !is_on_floor:
				is_on_floor = true
				GlobalVar.play_sound("sfx_soft_fall_two")
